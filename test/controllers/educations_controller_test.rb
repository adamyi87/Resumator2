...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: {  date: @education. date, award: @education.award, description: @education.description, location: @education.location, school: @education.school }
    end
  ...
  test "should update education" do
    patch :update, id: @education, education: {  date: @education. date, award: @education.award, description: @education.description, location: @education.location, school: @education.school }
    assert_redirected_to education_path(assigns(:education))
  end
